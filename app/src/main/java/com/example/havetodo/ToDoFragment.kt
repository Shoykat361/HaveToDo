...
import com.example.havetodo.Dailogue.CustomAlertDialog
import com.example.havetodo.PreferenceData.LoginPreference
import com.example.havetodo.Utlis.*
import com.example.havetodo.ViewModels.TodoViewModel
import com.example.havetodo.adapters.TodoAdapter
import com.example.havetodo.databinding.FragmentToDoBinding
    ...
    private fun performTodoRowAction(model: TodoModel, action: String) {
        when(action) {
            ...
            todo_edit -> {
                ...
                findNavController().navigate(R.id.action_toDoFragment_to_newTodoFragment, bundle)
